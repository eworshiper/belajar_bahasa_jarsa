<div class="leftkursus">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 280px;">
        <a href="/Home" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <span id="projectname" class="fs-4"><b>Jarsa</b></span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <form action="/Sub-Course" method="get">
                    <input type="hidden" name="Kursus" value="Inggris">
                    <input type="hidden" name="Sub-Course" value="Grammar">
                    <button class="nav-link text-white" aria-current="page" type="submit">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                ...
                <li><a class="dropdown-item" href="/PilihKursus">Kursus</a></li>
